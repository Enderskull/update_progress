...
const int ledPin = 2;
//const int resetButtonPin = 4;  // Change this to the pin connected to the reset button
...
void setup()
{
  ...
  //pinMode(resetButtonPin, INPUT_PULLUP); // Configure the button pin as input with internal pull-up resistor
}
